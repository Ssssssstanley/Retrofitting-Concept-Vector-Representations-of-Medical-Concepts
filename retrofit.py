...
if __name__=='__main__':
  ...
  for lex in lexs:
     print lex
     input = './cui_vecs_PubMedCUI10_'+lex+'.txt'
     output='./Re_cui_vecs_PubMedCUI10_'+lex+'.txt'
     lexiconfile = './Semantic_Lexicons/umls_structure_'+lex+'.txt'
     numIter=15
     wordVecs = read_word_vecs(input)
     lexicon = read_lexicon(lexiconfile, wordVecs)
     outFileName = output
